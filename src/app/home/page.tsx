  ...
  if (identity.configured && identity.profile && !state.circle) {
    return (
      <main className="relative mx-auto min-h-screen max-w-xl px-5 pb-16 pt-6 sm:px-8">
        ...
        <h1 className="font-display mt-1 text-[2.35rem] font-bold leading-tight text-slate-900">
          {firstName}
        </h1>
        <p className="mt-3 max-w-sm text-[15px] leading-relaxed text-slate-500">
          You&apos;re signed in. A small Circle will show up here once matching runs.
        </p>
